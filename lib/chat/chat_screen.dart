...
class _ChatScreenState extends State<ChatScreen> {
  ...
  createUser(){
    ...
    String myIdUnCut = myInfo.substring(myInfo.lastIndexOf(':')+1, );
      ...
      builder: (context, snapshot) {
        return snapshot.hasData
            ...
            itemBuilder: (context, index) {
              ...
              ChatCard(
                isNewMessage: emailWithNewMessage == snapshot.data.docs[index]["userEmail"] ? true : false,
                myId: myId,
                myEmail: user.email,
                ...
                friendImage: snapshot.data.docs[index]["userImage"] == null ? "https://huyhoanhotel.com/wp-content/uploads/2016/05/765-default-avatar.png" : snapshot.data.docs[index]["userImage"],
              ) : SizedBox()
              ;
            }
        )
